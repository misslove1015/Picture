...
- (void)setupNavBar {
    ...
    selectTip.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"BoPhotoPicker.bundle/images/BoSelectGroup_tip"]];
    ...
    [label mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.trailing.mas_equalTo(navBar);
        make.bottom.mas_equalTo(navBar).offset(0.5);
        make.left.mas_equalTo(navBar).offset(0);
    }];
}
